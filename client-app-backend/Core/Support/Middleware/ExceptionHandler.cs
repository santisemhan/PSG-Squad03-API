namespace client_app_backend.Core.Support.Middleware
{
    ...
    public sealed class ExceptionHandler
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            catch (PSGClientException exception)
            {
                await SendPayload(context, Envelope.Error(exception.Message), exception.HttpStatusCode);
            }
